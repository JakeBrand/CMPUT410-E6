...
def index(request):
    # Request the context of the reqeust
    # The context contains information such as client's machine
    context = RequestContext(request)

    # Get all links
    links = Link.objects.all()
    # when this links object is passed, {%%} and {{}} is used to access them
